...
describe('Teste de API - Rotas', function () {
    ...
    describe('ROTAS GET', function () {
        it('GET /api/task - Deve retornar status 404 quando rota for inválida.', function (done) {
            request
                .get('/api/task')
                .expect(404)
        ...
        it('GET /api/tasks - Deve retornar lista de tasks.', function (done) {
            request
                .get('/api/tasks')
        ...
        it('GET /api/tasks/12 - Retorna status 404 quando task não for encontrada.', function (done) {
            request
                .get('/api/tasks/12')
                .expect(404)
                .end(function (err, res) {
        ...
        it('GET /api/tasks/:_id - Deve retornar uma task de acordo com o _id.', function (done) {
            request
    ...
    describe('ROTAS POST', function () {
        it('POST /api/tasks	- Não deve inserir uma task sem title e completionDate', function (done) {
            request
                .post('/api/tasks')
                .send({
        ...
        it('POST /api/tasks	- Deve inserir uma nova task e retornar o objeto inserido.', function (done) {
            let t = {
    ...
    describe('ROTAS PUT', function () {
        it('PUT /api/tasks/:_id - Deve retornar erro 404 quando a task a ser atualizada não existir.', function (done) {
            request
                .put('/api/tasks/12')
        ...
        it('PUT /api/tasks/:_id - Deve atualizar uma task de acordo com o _id e retornar o objeto atualizado.', function (done) {
            let t = {
    ...
    describe('ROTAS DELETE', function () {
        it('PUT /api/tasks/:_id - Deve retornar erro 404 quando a task a ser removida não existir.', function (done) {
            request
                .delete('/api/tasks/12')
                .expect(404)
                .end(function (err, res) {
        ...
        it('DELETE /api/tasks/:_id - Deve remover uma task de cordo com o _id e retornar o objeto removido.', function (done) {
